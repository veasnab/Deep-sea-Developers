...
-- Expected: A set that includes all the columns from both the "CTD_EQUIPMENT" and "CTD_LOG" tables. It will show the equipment being used in CTD operations along with equipment that is not being used. 
SELECT * 
FROM CTD_EQUIPMENT 
